namespace ShopApp.Migrations
{
    ...
    public partial class WorkinOnMessageV14 : DbMigration
    {
        public override void Up()
        {
            ...
            AddForeignKey("dbo.Message", "Receiver_UserID", "dbo.User", "UserID", cascadeDelete: false);
            AddForeignKey("dbo.Message", "Sender_UserID", "dbo.User", "UserID", cascadeDelete: false);
        }
